...
public class BlueSkystone_11229 extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        pidRotate.PIDcon(0.001,0.0018,0.135);
...

        {
            ...
            else if (updatedRecognitions.size() == 2) skystonePostion = seeTwoObj(updatedRecognitions);
    ...
    private void rotate(int degrees, double power,boolean reset) {
        ...
        if (degrees < 0) {
            ...
            } while (opModeIsActive() && pidRotate.getError() < 3 || pidRotate.getError() > -3 );
        } else
            do {
                pidRotate.setSensorValue(getAngle());
                power = pidRotate.calculate();

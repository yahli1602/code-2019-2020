...
@Autonomous(name="BlueStone 11226", group="11226 Stone")

public class PIDdrive_11226_blue extends LinearOpMode
{
    ...
    private void moveStone(int SP , boolean where){
        if (where){
            ...
            if (SP == 1) driveInches(65,0.03,0.4);
